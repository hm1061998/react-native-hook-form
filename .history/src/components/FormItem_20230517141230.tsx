...
const FormItem = ({
  ...
  const newChildren = children as React.ReactElement;
  const {
    field,
    fieldState: { error },
  } = useController({
        ...
        >
          ...
          {cloneElement(Children.only(children as any), {
            ...
            [handleChange!]: (e: any) => {
              ...
              newChildren.props[handleChange!]?.(onChangeFormatter!(e));
            },
            [handeBlur!]: () => {
              field.onBlur();
              newChildren.props[handeBlur!]?.(field.value);
            },
